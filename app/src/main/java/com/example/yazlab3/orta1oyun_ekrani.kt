...
class orta1oyun_ekrani : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lateinit var orta1basla:Button
        ...
        lateinit var orta1sure: TextView
        lateinit var orta1puan: TextView
        lateinit var orta1karttakiisim:TextView
        ...
        setContentView(R.layout.activity_orta1oyun_ekrani)

        orta1basla=findViewById(R.id.orta1basla)
        image1=findViewById(R.id.orta1foto1)
        image2=findViewById(R.id.orta1foto2)
        image3=findViewById(R.id.orta1foto3)
        image4=findViewById(R.id.orta1foto4)
        image5=findViewById(R.id.orta1foto5)
        image6=findViewById(R.id.orta1foto6)
        image7=findViewById(R.id.orta1foto7)
        image8=findViewById(R.id.orta1foto8)
        image9=findViewById(R.id.orta1foto9)
        image10=findViewById(R.id.orta1foto10)
        image11=findViewById(R.id.orta1foto11)
        image12=findViewById(R.id.orta1foto12)
        image13=findViewById(R.id.orta1foto13)
        image14=findViewById(R.id.orta1foto14)
        image15=findViewById(R.id.orta1foto15)
        image16=findViewById(R.id.orta1foto16)
        ...
        orta1sure=findViewById(R.id.orta1süre)
        orta1puan=findViewById(R.id.orta1puan)
        orta1karttakiisim=findViewById(R.id.orta1karttakiisim)
        ...
        orta1basla.setOnClickListener {
            click?.start()
            orta1basla.isEnabled=false
            orta1basla.isVisible=false
            for(i in fotolar){
                i.isEnabled=true
            }
            ...
            timer=object : CountDownTimer(/* millisInFuture = */ 46000,/* countDownInterval = */ 1000){
                override fun onTick(saniye: Long) {
                    ...
                    orta1sure.text=(saniye/1000).toString()
            ...
            if(i==0 || i==1){
                fotolar[i].setOnClickListener{
                    ...
                    if(sayac==1){
                        ...
                        orta1karttakiisim.text=isim_tut1
                    }
                    else if(sayac==2){
                        açılmışadet++
                        if(açılmışadet==1){
                        ...
                        orta1karttakiisim.text=isim_tut2
                        sayac=0
                        ...
                        if(image_tut1!=image_tut2){
                            ...
                            if(aile_tut1==aile_tut2){
                                ...
                                orta1puan.text=(puan_son.toInt()).toString()
                            }
                            else{
